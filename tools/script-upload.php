			...
			<div class="row-fluid">
				<div class="span6 offset3">
					...
					<form action="script-upload-success.php" method="post">
						...
						<input placeholder="Episode ID" type="text" name="id"> <label for="id"> (Leave this blank to create a new episode. Don't fuck around)</label><br>
						<input placeholder="Episode Title" type="text" name="title"> <label for="title">e.g. Jake and Amir: Cheryl Part 2 w/ Allison Williams</label><br/>
						<input placeholder="Episode Link" type="text" name="link"> <label for="link">The link listed in the 
							<a href="http://www.reddit.com/r/jakeandamir/comments/11ai05/the_unofficial_ja_master_list/c7hlkoq">Reddit master list </a> 
							(e.g. http://www.jakeandamir.com/post/1544860521/toilet-paper )</label> <br/>
						<input placeholder="Embed source" type="text" name="embed-src"> <label for="embed-src">http://www.collegehumor.com/e/6338943</label><br/>
						...
						<input placeholder="Scribe" type="text" name="scribe"> <label for="scribe">Transcriber's reddit name e.g. <i>seeegma</i></label><br/>
